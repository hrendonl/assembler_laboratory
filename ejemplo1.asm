...
main:
    ...
    # Inicialmente, asumimos que el primer número es el mayor
    move $t3, $t0

    # Compara el segundo número con el mayor actual
    bgt $t1, $t3, update_max1
    move $t1, $t3

update_max1:
    # Compara el tercer número con el mayor actual
    bgt $t2, $t1, update_max2
    move $t2, $t1
